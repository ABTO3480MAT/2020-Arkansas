...
public class OchoV2Path extends Path implements PathInterface{
    ...
    public OchoV2Path() {
        ...
        waypoints.add(new DataHolder(new Vector2(1,1),""));
        waypoints.add(new DataHolder(new Vector2(-1,2),""));
        waypoints.add(new DataHolder(new Vector2(0,3),""));
        buildPath(waypoints);
