...
public class OchoV2Path3 extends Path implements PathInterface{
    ...
    public OchoV2Path3() {
        ...
        waypoints.add(new DataHolder(new Vector2(0.75,3.25),"")); //x,y
        waypoints.add(new DataHolder(new Vector2(-0.10,2.75),""));
        waypoints.add(new DataHolder(new Vector2(-1.40,1.75),""));
        buildPath(waypoints);
