package frc.robot.paths.DerechaAtras;
...
public class DerechaAtrasPath2 extends Path implements PathInterface{

    public DerechaAtrasPath2() {
        RestartPath();
        ...
        waypoints.add(new DataHolder(new Vector2(-1.75,2.75),""));
        buildPath(waypoints);
