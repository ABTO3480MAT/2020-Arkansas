package frc.robot.paths.IzquierdaAdelante;
...
public class IzquierdaAdelantePath2 extends Path implements PathInterface{

    public IzquierdaAdelantePath2() {
        RestartPath();
        ...
        waypoints.add(new DataHolder(new Vector2(0,1),""));
        waypoints.add(new DataHolder(new Vector2(0,0),""));
        waypoints.add(new DataHolder(new Vector2(1,-0.5),""));
        waypoints.add(new DataHolder(new Vector2(1.25,-1.5),""));
        waypoints.add(new DataHolder(new Vector2(1.5,-2.25),""));
        buildPath(waypoints);
