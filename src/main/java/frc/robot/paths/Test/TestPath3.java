...
public class TestPath3 extends Path implements PathInterface{
    ...
    public TestPath3() {
        ...
        waypoints.add(new DataHolder(new Vector2(-1.5,5),"")); //x,y
        waypoints.add(new DataHolder(new Vector2(-1.5,1.5),""));
