...
public class TestPath2 extends Path implements PathInterface{
    ...
    public TestPath2() {
        ...
        waypoints.add(new DataHolder(new Vector2(0,1),"")); //x,y
        waypoints.add(new DataHolder(new Vector2(-1.5,1.5),""));
        waypoints.add(new DataHolder(new Vector2(-1.5,5),""));
        buildPath(waypoints);
