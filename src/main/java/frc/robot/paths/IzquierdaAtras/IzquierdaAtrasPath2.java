package frc.robot.paths.IzquierdaAtras;
...
public class IzquierdaAtrasPath2 extends Path implements PathInterface{

    public IzquierdaAtrasPath2() {
        RestartPath();
        ...
        waypoints.add(new DataHolder(new Vector2(-0.10,3),""));
        buildPath(waypoints);
