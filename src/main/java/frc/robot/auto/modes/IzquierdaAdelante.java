...
import frc.robot.paths.IzquierdaAdelante.IzquierdaAdelantePath;
import frc.robot.paths.IzquierdaAdelante.IzquierdaAdelantePath2;

public class IzquierdaAdelante extends AutoModeBase {

    DrivePathAction path_1;
    DrivePathAction path_2;

    public IzquierdaAdelante() {
        path_1 = new DrivePathAction(new IzquierdaAdelantePath(),true);
        path_2 = new DrivePathAction(new IzquierdaAdelantePath2(),true);
    }
